...
class Controlpaquete extends CI_Controller {

    public function __construct() {
        parent::__construct();
        include_once("lib/inc/jqgrid_dist.php");
        $this->lang->load('generales');
        $this->lang->load('controlpaquete');
        $this->load->helper('form');
        $this->load->library('form_validation');
        $this->load->model('controlpaquete_m');
    }
    ...
    public function index() {
        ...
        $this->load->view('frontend/controlpaquete/controlpaquete_list_v');
    ...
    public function get_controlpaquete_list(){
        // if ($this->seguridad->sec_class(__METHOD__)) return;
        $spName = 'CONTROLPAQUETE_LIST';
