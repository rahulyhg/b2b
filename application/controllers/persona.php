...
/*   
    Controlador persona: prueba previas para el siscont
 * creado por: Cesar Mamani Dominguez
 * fecha creacion: 11-03-2015
 * modificado por
...
class Persona extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('frontend/persona/persona_list_v', $arrSesion);
