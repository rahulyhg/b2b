...
class Rptctacaja extends CI_Controller {
    var $_arr_Sesion;
    ...
    public function __construct() {
        ...
        $this->lang->load('rptctacaja');
        $this->load->helper('form');
        $this->load->helper('date');
        $this->load->library('form_validation');
        $this->load->model('rptctacaja_m');
    }
    public function index() {
        ...
        $arrSesion['title'] = lang('rptctacaja.title');
        $arrMenu['mGroup'] = 'm_consultas';
        $arrMenu['mOption'] = 'm_consultas_05';
        ...
        $this->load->view('frontend/rptctacaja/rptctacaja_list_v',$arraySesion);
    ...
    function get_proyectos(){
        ...
        $objmovimiento = new $this->rptctacaja_m;
    ...
    function get_conceptos(){
        if ($this->seguridad->sec_class(__METHOD__)) return;
        $arrParam = array(null,2);
        $objtransaccion = new $this->rptctacaja_m;
    ...
    public function view_movimiento(){
        ...
        $result = $this->rptctacaja_m->get_transaccion($data);
        ...
        if (count($result) == 0) {
            ...
            $arrSesion['arrTipo'] = $this->rptctacaja_m->get_tipo();
            $arrSesion['arrCaja'] = $this->rptctacaja_m->get_caja();
            $arrSesion['arrSproyecto'] = $this->rptctacaja_m->get_sproyecto();
            $arrSesion['arrProyecto'] = $this->rptctacaja_m->get_proyecto();
            $arrSesion['arrSConcepto'] = $this->rptctacaja_m->get_sconcepto();
            $arrSesion['arrConcepto'] = $this->rptctacaja_m->get_concepto();
            $arrSesion['arrEmpresa'] = $this->rptctacaja_m->get_empresa();
