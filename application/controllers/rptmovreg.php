...
class Rptmovreg extends CI_Controller {
    var $_arr_Sesion;
    ...
    public function __construct() {
        ...
        $this->lang->load('rptmovreg');
        $this->load->helper('form');
        $this->load->helper('date');
        $this->load->library('form_validation');
        $this->load->model('rptmovreg_m');
    }
    public function index() {
        ...
        $arrMenu['mOption'] = 'm_consultas_02';
        $arraySesion['jsonCajas']     =  $this->rptmovreg_m->get_caja();
        $arraySesion['jsonProyectos'] =  $this->rptmovreg_m->get_proyecto();
        $arraySesion['jsonConceptos'] =  $this->rptmovreg_m->get_concepto();
        ...
        $this->load->view('frontend/rptmovreg/rptmovreg_list_v',$arraySesion);
    ...
    public function view_movimiento(){
        ...
        $result = $this->rptmovreg_m->get_transaccion($data);
        ...
        if (count($result) == 0) {
            ...
            $arrSesion['arrTipo'] = $this->rptmovreg_m->get_tipo();
            $arrSesion['arrCaja'] = $this->rptmovreg_m->get_caja();
            $arrSesion['arrSproyecto'] = $this->rptmovreg_m->get_sproyecto();
            $arrSesion['arrProyecto'] = $this->rptmovreg_m->get_proyecto();
            $arrSesion['arrSConcepto'] = $this->rptmovreg_m->get_sconcepto();
            $arrSesion['arrConcepto'] = $this->rptmovreg_m->get_concepto();
            $arrSesion['arrEmpresa'] = $this->rptmovreg_m->get_empresa();
