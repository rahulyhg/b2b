...
class Transaccion extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->lang->load('transac');
        $this->load->helper('form');
        $this->load->library('form_validation');
        $this->load->model('transaccion_m');
    }
    ...
    public function index() {
        ...
        $arrSesion['controller'] = 'transaccion';
        $arrMenu['mGroup'] = 'm_datos';
        $arrMenu['mOption'] = 'm_datos_01';
        $arrSesion['title'] = lang('transac.title');
        
        $fechas = array(
            'fecha_ini'     => '2012-09-23',
            'fecha_fin'     => '2011-09-23'
        );
        ...
        $this->load->view('frontend/transaccion/transaccion_list_v', $arrSesion);
    ...
    public function update_fechas($f_ini,$f_fin){
        if ($this->seguridad->sec_class(__METHOD__)) return;
        $ini = null;
        $fin = null;
        ...
        echo('parametros: ini-'.$f_ini.' / fin-'.$f_fin.' ');
        echo('en sesion: ini-'.$ini.' / fin-'.$fin.' ');
    }
    ...
    public function get_transaccion_list(){
        ...
        $arrSesion = $this->session->userdata('fechas');
        $f_ini = $arrSesion['fecha_ini'];
        $f_fin = $arrSesion['fecha_fin'];
        
        $arrParam = array(null,1,$f_ini,$f_fin);
