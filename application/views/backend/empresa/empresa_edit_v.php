...
<div class="box color_light">
    <div class="modal-header">
        ...
        <h4> <i class="icon-book"></i>
            <span><?= lang('emp.edit_title') ?></span> 
        </h4>
    </div>
    <div class="content">
        <form id="frmNew" action="<?= site_url('empresa/upd_empresa') ?>" method="POST" class="form-horizontal row-fluid">
            ...
            <div class="form-row control-group row-fluid">
                ...
                <div class="controls span8">
                    <span class="row-fluid k-textbox">
                        <input type="text" class="row-fluid" id="txt_c_nomraz" name="txt_c_nomraz" value="<?php if (isset($txt_c_nomraz)) echo $txt_c_nomraz ?>">
                    </span>
                </div>
            </div>
            <div class="form-row control-group row-fluid">
