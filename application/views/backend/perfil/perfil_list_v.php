...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var Seleccione = "<?= lang('prof.selec')?>";
        // boton Nuevo
...
//        }));
            ...
            transport: {
                read:  function(options){
                    $.ajax({
                        type: "POST",
                        dataType: "json",
                        url: "<?= site_url('perfil/get_perfil_list') ?>",
        ...
        $("#tbData").kendoGrid({
            ...
            columns: [ 
                { field: "PerfilId", title: "<?= lang('user.usu') ?>" },
                { field: "NombrePerfil", title: "<?= lang('user.nom') ?>" },
                { field: "PerfilPadreId", title: "<?= lang('user.fec_vig') ?>" },
