...
<div class="box color_light">
    <div class="modal-header">
        ...
        <h4> <i class="icon-book"></i>
            <span><?= lang('proy.conf_title') ?></span>
        </h4>
    </div>
    <div class="content cursor">
        <form id="frmNew" action="<?= site_url('proyecto/upd_conceptos_activos') ?>" method="POST" class="form-horizontal row-fluid">
            ...
            <div class="form-row control-group row-fluid">
                <label for="hint-field" class="control-label span3"><?= lang('proy.proy') ?></label>
            ...
            <div class="form-row control-group row-fluid ">
                <table style="width: 70%" >    
                    <tr>
                        <td style="width: 100%"><?= lang('proy.conc') ?></td>
                    </tr>
                    <tr>
                        <td style="width: 50%">
