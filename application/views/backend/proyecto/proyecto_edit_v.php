...
<div class="box color_light">
    <div class="modal-header">
        ...
        <h4> <i class="icon-book"></i>
            <span><?= lang('proy.edit_title') ?></span> 
        </h4>
    </div>
    <div class="content">
        <form id="frmNew" action="<?= site_url('proyecto/upd_proyecto') ?>" method="POST" class="form-horizontal row-fluid">
            ...
            <div class="form-row control-group row-fluid">
                ...
                <div class="controls span8">
                    <span class="row-fluid k-textbox">
                        <input type="text" class="row-fluid" id="txt_c_proyecto" name="txt_c_proyecto" value="<?php if (isset($txt_c_proyecto)) echo $txt_c_proyecto ?>">
                    </span>
                </div>
            </div>
            <div class="form-row control-group row-fluid">
                ...
                <div class="controls span6">
                    <input id="cb_cta_control" name="cb_cta_control" class="row-fluid" value="<?php if (isset($cb_cta_control)) echo $cb_cta_control ?>"/>
                </div>
            </div>
            <div class="form-row control-group row-fluid">
                <label for="normal-field" class="control-label span3"><?= lang('proy.ctaing') ?></label>
                <div class="controls span6">
                    <input id="cb_cta_ingreso" name="cb_cta_ingreso" class="row-fluid" value="<?php if (isset($cb_cta_ingreso)) echo $cb_cta_ingreso ?>"/>
                </div>
            </div>
            <div class="form-row control-group row-fluid">
