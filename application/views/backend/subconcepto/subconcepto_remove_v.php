...
<div class="box color_light">
    <div class="modal-header">
        ...
        <h4> <i class="icon-book"></i>
            <span><?= lang('sconcep.delete_title') ?></span> 
        </h4>
    </div>
    <div class="content">
        <form id="frmNew" action="<?= site_url('subconcepto/dlt_subconcepto') ?>" method="POST" class="form-horizontal row-fluid">
          <div class="form-row control-group row-fluid hide">
            ...
            <div class="form-row control-group row-fluid">
                ...
                <div class="controls span8">
                    <span class="row-fluid k-textbox">
                        <input type="text" class="row-fluid" id="c_scodigo" name="c_scodigo" value="<?php if (isset($c_scodigo)) echo $c_scodigo ?>" disabled>
                    </span>
                </div>
            </div>
            ...
            <div class="form-row control-group row-fluid">
                ...
                <div class="controls span8">
                    <span class="row-fluid k-textbox">
                        <input type="text" class="row-fluid" id="c_sconcepto" name="c_sconcepto" value="<?php if (isset($c_sconcepto)) echo $c_sconcepto ?>" disabled>
                    </span>
                </div>
            </div>
          ...
          <div class="form-row control-group row-fluid">
                ...
                <div class="controls span6">
                    <input id="c_id_concepto" name="c_id_concepto" class="row-fluid" value="<?php if (isset($c_id_concepto)) echo $c_id_concepto ?>" disabled>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    */                        
    $(document).ready(function () {
        ...
        $.populateComboBox('#c_id_concepto', "<?= lang('sconcep.selcon')?>", 'Concepto', 'id_concepto', <?php echo (isset($arrConceptos)) ? $arrConceptos : 'null' ?>, 1);//, arr_TipEmp);       
        c_id_concepto = $("#c_id_concepto").data("kendoComboBox");   
