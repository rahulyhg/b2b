...
<div class="box color_light">
    <div class="modal-header">
        ...
        <h4> <i class="icon-book"></i>
            <span><?= lang('subproy.edit_title') ?></span> 
        </h4>
    </div>
    <div class="content">
        <form id="frmNew" action="<?= site_url('subproyecto/upd_subproyecto') ?>" method="POST" class="form-horizontal row-fluid">
            ...
            <div class="form-row control-group row-fluid">
                ...
                <div class="controls span8">
                    <span class="row-fluid k-textbox">
                        <input type="text" class="row-fluid" id="txt_c_sproyecto" name="txt_c_sproyecto" value="<?php if (isset($txt_c_sproyecto)) echo $txt_c_sproyecto ?>">
                    </span>
                </div>
            </div>
            <div class="form-row control-group row-fluid">
                ...
                <div class="controls span6">
                    <input id="cb_proyecto" name="cb_proyecto" class="row-fluid" value="<?php if (isset($cb_proyecto)) echo $cb_proyecto ?>"/>
                </div>
            </div>
            <!--<div class="form-row control-group row-fluid">
