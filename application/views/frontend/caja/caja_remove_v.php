...
<div class="box color_light">
    <div class="modal-header">
        ...
        <h4> <i class="icon-book"></i>
            <span><?= lang('caja.delete_title') ?></span> 
        </h4>
    </div>
    <div class="content">
        <form id="frmNew" action="<?= site_url('caja/dlt_caja') ?>" method="POST" class="form-horizontal row-fluid">
            ...
            <div class="form-row control-group row-fluid">
                ...
                <div class="controls span8">
                    <span class="row-fluid k-textbox">
                        <input type="text" class="row-fluid" id="txt_c_caja" name="txt_c_caja" value="<?php if (isset($txt_c_caja)) echo $txt_c_caja ?>" disabled>
                    </span>
                </div>
            </div>
            <div class="form-row control-group row-fluid">
                ...
                <div class="controls span6">
                    <input id="cb_moneda" name="cb_moneda" class="row-fluid" value="<?php if (isset($cb_moneda)) echo $cb_moneda ?>" disabled>
                </div>
            </div>
            <div class="form-row control-group row-fluid">
