...
<div class="box color_light">
    <div class="modal-header">
        ...
        <h4> <i class="icon-book"></i>
            <span><?= lang('ctacon.delete_title') ?></span> 
        </h4>
    </div>
    <div class="content">
        <form id="frmNew" action="<?= site_url('ctacontable/dlt_ctacontable') ?>" method="POST" class="form-horizontal row-fluid">
            ...
            <div class="form-row control-group row-fluid">
                ...
                <div class="controls span8">
                    <span class="row-fluid k-textbox">
                        <input type="text" class="row-fluid" id="txt_c_cuenta" name="txt_c_cuenta" value="<?php if (isset($txt_c_cuenta)) echo $txt_c_cuenta ?>" disabled>
                    </span>
                </div>
            </div>
            
            <div class="form-row control-group row-fluid">
                <label for="normal-field" class="control-label span3"><?= lang('ctacon.estado') ?></label>
