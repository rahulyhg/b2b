...
$(document).ready(function() {
       ...
       function fillkendogrid(data){           
            ...
            selectable: "single",
            columns: [
                { field: "Contratista", width: 100, title: "<?=lang('ctr.ctra')?>" },
                { field: "NumeroContrato", title: "<?=lang('ctr.nroc')?>" },
                { field: "DescripcionCorta", title: "<?=lang('ctr.desc')?>"},
                { field: "ContractHolder", title: "<?=lang('ctr.ctrh')?>" },
