...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var jsonInicial = [{"Contratista":"", "Persona":"","Requisito":"","FechaInicio":"", "FechaFin":""}];
        var grid;
        ...
        function fillkendogrid(data){            
            ...
            pageable: false,
            columns: [
                { field: "Contratista", title:"<?=lang('ctr.ctrarxv')?>", width: "200px"                },  
                { field: "Persona", title:"<?=lang('ctr.perrxv')?>", width: "200px"                },
                { field: "Requisito", title:"<?=lang('ctr.reqrxv')?>", width: "200px"                },  
        ...
        function get_detalle(tipoID,callback)
        {
            $.ajax({
               type: "POST",   
               dataType: "json",
               url: "main/get_requisitos_x_vencer_list",
               data: {tipoId : tipoID},
               success: callback,
               beforeSend: function(){
