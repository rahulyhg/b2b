...
<div class="box color_light" >
    ...
    <div class="content" style="width: 878px !important; height: 650px !important;">
        <form id="frmNew" class="form-horizontal row-fluid">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.populateComboBox('#cb_caja', "", 'c_tipo', 'c_tipo', <?php echo (isset($arrTipo)) ? $arrTipo : 'null' ?>, 1);     
        cb_caja = $("#cb_caja").data("kendoComboBox");
        
        $.populateComboBox('#cb_sproy',"", 'SProyecto', 'c_scodigo', <?php echo (isset($arrSproyecto)) ? $arrSproyecto : 'null' ?>, 1);      
        //$.populateComboBox('#cb_sproy', "", 'c_tipo', 'c_tipo', <?php echo (isset($arrTipo)) ? $arrTipo : 'null' ?>, 1);     
...
//        }));
        //$.saveModal('#frmNew', '#close', '#tbData', '#msgForm', "<?= lang('g.msgProcesing')?>");
