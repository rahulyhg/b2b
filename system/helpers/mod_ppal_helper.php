        ...
        if (user_is_logged()){
            ...
            if($sess_use_database){
                ...
                foreach($query->result() as $row){
                    ...
                    if ($arrSesion['user']==$arrData['ses_usuario']['user']){
                                
                        // borramos la sesion de la db
                        $CI->db->delete('MPC_TM_SESION',array('session_id' => $row->session_id));
